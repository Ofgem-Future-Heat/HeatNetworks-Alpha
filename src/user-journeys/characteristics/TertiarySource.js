...
const TertiarySource = ({ characteristicsAnswers, setCharacteristicsAnswers }) => {
  const navigate = useNavigate()

  const handleTertiarySource = (e) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    navigate('/user-journeys/characteristics/heat-network-fuel')
  }

  return (
    <div>
      <GovUK.BackLink href='#' onClick={ () => { navigate(-1) } } ></GovUK.BackLink>
        <GovUK.H1>What is your tertiary energy source?</GovUK.H1>
